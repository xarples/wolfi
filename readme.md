...
<html>
<head>
  <link href="https://unpkg.com/xarples@wolfi@0.12.2/dist/wolfi.min.css" rel="stylesheet">
...
<body>
  ...
  <script src="https://unpkg.com/xarples@wolfi@0.12.2/dist/wolfi.min.js"></script>
  <script>
    new Vue({
      el: '#app'
    })
