      ...
      <w-grid-container>
        <w-grid-row>
          <w-grid-column :sm="12" :md="6">
            ...
            <w-text variant="lead">
              Wolfi has everything you need to create amazing, responsive and
              mobile-first projects on the web using Vue.js
            </w-text>
            <g-link to="/docs/getting-started/">
          ...
          <w-grid-column :sm="12" :md="6">
            <!-- <img
              ...
              src="https://github.com/xarples/wolfi/blob/master/logo.png?raw=true"
            /> -->
          </w-grid-column>
        </w-grid-row>
      </w-grid-container>
      ...
      <w-grid-container>
        <w-grid-row>
          <w-grid-column :sm="12" :md="3">
            <w-icon name="expand" size="3x" :style="{ marginBottom: '.5em' }" />
            <w-text variant="h4">
          ...
          <w-grid-column :sm="12" :md="3">
            ...
            <w-text>
              Built with latest version of Vue.js.
            </w-text>
          </w-grid-column>
          <w-grid-column :sm="12" :md="3">
            <w-icon
